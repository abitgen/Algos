...
class TestCheckIfItIsAStraightLine {
    ...
    fun `test 1 - should be true`(){
        assertThat(CheckPointsAreInStraightLine.checkStraightLine(
    ...
    fun `test 2 - should be true`(){
        assertThat(CheckPointsAreInStraightLine.checkStraightLine(
            arrayOf(intArrayOf(-7,-3),intArrayOf(-7,-1),intArrayOf(-2,-2),intArrayOf(0,-8),intArrayOf(2,-2),intArrayOf(5,-6),intArrayOf(5,-5),intArrayOf(1,7))
        ), `is`(true))
    }
}